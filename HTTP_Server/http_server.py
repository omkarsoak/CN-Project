        ...
        if isValid:
            ...
            if requestedMethod == "GET":
                ...
                response = handleHEADRequest(
                    httpVersion, restHeaders, requestedPath)
                writeResponseToFile(response,'head_response.txt')
        else:
...
def startServer(serverSocket=None):
    ...
    while True:
        try:
            ...
            # discared them
            if threading.active_count() <= maxConnections:
